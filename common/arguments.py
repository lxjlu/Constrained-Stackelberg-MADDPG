...
def get_args():
    ...
    parser.add_argument("--action-type", type=str, default="continuous", help="number of time steps")
    parser.add_argument("--version", type=str, default="bilevel", help="version of algorithm")
    ...
    parser.add_argument("--min_noise_rate", type=float, default=0., help="min noise rate")
